 ...
 */
public class SumarBodegaFrame extends javax.swing.JFrame {
    ControladorSucursal cs;
    ControladorBodega cb;
    Bodega bodega = null;
    /**
     * Creates new form SumarBodegaFrame
     * @param cb
     * @param cs
     */
    public SumarBodegaFrame(ControladorBodega cb, ControladorSucursal cs) {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sumar Bodega.P", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cantidadt1)
                            .addComponent(cantidadt2)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cantidadt1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cantidadt2, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar SumarBodegaFrame");
        ...
        if(bodega != null){
            ...
            cantidadt1.setText(String.valueOf(bodega.getDetalleBodega().get(0).getCantidadTotal()));
        }else{
    ...
    private void agregarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarbtActionPerformed
        // TODO add your handling code here:
        System.out.println("agregar SumarBodegaFrame");
        if(bodega != null){
            Double sumando = Double.parseDouble(cantidadt2.getText());
            Sucursal suc = cs.buscarSucursal((String)sucursalcombox.getSelectedItem());
            if(cb.sumarBodega(bodega, sumando, suc)==true){
                JOptionPane.showMessageDialog(null, "Adicion realizada con exito");
                nombret.setText("");
                cantidadt1.setText("");
                cantidadt2.setText("");
                cb.listarBodega();
            }else{
                JOptionPane.showMessageDialog(null, "No se pudo efectuar la adicion");
            }
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir SumarBodegaFrame");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SumarBodegaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SumarBodegaFrame().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField cantidadt1;
    private javax.swing.JTextField cantidadt2;
