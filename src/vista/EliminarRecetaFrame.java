 ...
 */
public class EliminarRecetaFrame extends javax.swing.JFrame {
    ControladorReceta cr;
    Receta receta = null;
    /**
     * Creates new form EliminarRecetaFrame
     * @param cr
     */
    public EliminarRecetaFrame(ControladorReceta cr) {
        initComponents();
        this.getContentPane().setBackground(new Color(125,125,125));
        this.cr = cr;
    }

    private EliminarRecetaFrame() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Restaurante Oritz & Asociados");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Receta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar ELIMINARECETAFRAME");
        receta = cr.buscarReceta(nombret.getText());
        if(receta != null){
            JOptionPane.showMessageDialog(null, "La receta se encuentra registrada");
        }else{
    ...
    private void eliminarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbtActionPerformed
        // TODO add your handling code here:
        System.out.println("eliminar ELIMINARECETAFRAME");
        if(receta != null){
            if(cr.eliminarReceta(receta.getId())==true){
                JOptionPane.showMessageDialog(null, "La receta se elimino con exito");
                nombret.setText("");
                cr.listarRecetas();
            }else{
                JOptionPane.showMessageDialog(null, "La receta no pudo ser eliminada");
            }
        }else{
            JOptionPane.showMessageDialog(null, "No se encontro la Receta");
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir ELIMINARECETAFRAME");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarRecetaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarRecetaFrame().setVisible(true);
            }
        });
    }
