 ...
 */
public class EliminarBodegaFrame extends javax.swing.JFrame {
    ControladorBodega cb;
    ControladorSucursal cs;
    Bodega b = null;
    Sucursal suc = null;
    /**
     * Creates new form EliminarBodegaFrame
     * @param cb
     * @param cs
     */
    public EliminarBodegaFrame(ControladorBodega cb, ControladorSucursal cs) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Bodega", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(nombret, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE)
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar ELIMINARBODEGAFRAME");
        b = cb.buscarBodega(nombret.getText()+(String)sucursalcombox.getSelectedItem());
        if(b != null){
            JOptionPane.showMessageDialog(null, "La bodega del producto: "+b.getNombre()+" esta registrada");
        }else{
            JOptionPane.showMessageDialog(null, "La bodega no esta registrada");
        }
    ...
    private void eliminarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbtActionPerformed
        // TODO add your handling code here:
        System.out.println("eliminar ELIMINARBODEGAFRAME");
        if(b != null){
            suc = cs.buscarSucursal((String)sucursalcombox.getSelectedItem());
            if(cb.eliminarBodega(b, suc)==true){
                JOptionPane.showMessageDialog(null, "La bodega se elimino con exito");
                nombret.setText("");
                cb.listarBodega();
            }else{
                JOptionPane.showMessageDialog(null, "No se pudo eliminar La bodega");
            }
        }else{
            JOptionPane.showMessageDialog(null, "PorFavor ingrese un nombre que este registrado");
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir ELIMINARBODEGAFRAME");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarBodegaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarBodegaFrame().setVisible(true);
            }
        });
    }
