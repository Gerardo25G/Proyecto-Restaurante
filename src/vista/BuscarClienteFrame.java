...
public class BuscarClienteFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form BuscarClienteFrame
     * @param cc
     */
    public BuscarClienteFrame(ControladorCliente cc) {
        initComponents();
        this.cc = cc;
        this.getContentPane().setBackground(new Color(125,125,125));
    }

    private BuscarClienteFrame() {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Cliente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar BUSCARCLIENTEFRAME");
        Cliente c = cc.buscarCliente(cedulat.getText());
        if(c != null){
            JOptionPane.showMessageDialog(null, "El cliente se encuentra registrado: \n"
                    + "Datos: \n"
                    + "Nombres: "+c.getPerNombre()+" "+c.getPerApellido()+"\n "
                    + "Cedula: "+c.getPerCedula()
                    + "Correo: "+c.getPerCorreo());
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir BUSCARCLIENTEFRAME");
        this.dispose();
