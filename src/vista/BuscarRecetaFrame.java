 ...
 */
public class BuscarRecetaFrame extends javax.swing.JFrame {
    ControladorReceta cr;
    /**
     * Creates new form BuscarRecetaFrame
     * @param cr
     */
    public BuscarRecetaFrame(ControladorReceta cr) {
        initComponents();
        this.getContentPane().setBackground(new Color(125,125,125));
        this.cr = cr;
    }

    private BuscarRecetaFrame() {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Receta", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(nombret, javax.swing.GroupLayout.DEFAULT_SIZE, 206, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar BUSCARRECETAFRAME");
        Receta receta = cr.buscarReceta(nombret.getText());
        if(receta != null){
            JOptionPane.showMessageDialog(null, "La receta se encuentra registrada. \n"
                    + "Datos: \n"
                    + "Nombre: "+receta.getNombre()+"\n"
                    + "Precio: "+receta.getPrecio()+" $");
            nombret.setText("");
        }else{
            JOptionPane.showMessageDialog(null, "La receta no se encuentra registrada");
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir BUSCARRECETA");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarRecetaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarRecetaFrame().setVisible(true);
            }
        });
    }
