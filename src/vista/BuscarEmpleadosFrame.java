 ...
 * @author GerardoG
 */
public class BuscarEmpleadosFrame extends javax.swing.JFrame {
    ControladorEmpleado ce = new ControladorEmpleado();
    /**
     * Creates new form ListarEmpleadosFrame
     * @param ce
     */
    public BuscarEmpleadosFrame(ControladorEmpleado ce) {
        initComponents();
        this.getContentPane().setBackground(new Color(125,125,125));
        this.ce = ce;
    }

    private BuscarEmpleadosFrame() {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Buscar Empleado", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cedulat, javax.swing.GroupLayout.DEFAULT_SIZE, 207, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar BUSCAREMPLEADOFRAME");
        Empleado em = ce.buscarEmpleado(cedulat.getText());
        if(em != null){
            JOptionPane.showMessageDialog(null, "El empleado se encuentra registrado. \n"+
                                                "Datos: \n"+ 
                                                "Nombres: "+em.getPerNombre()+" "+em.getPerApellido()+"\n"+
                                                "Celular: "+em.getPerTelCelular());
        
        }else{
            JOptionPane.showMessageDialog(null, "El empleado con numero de cedula: "+em.getPerCedula()+" No esta"
                                            + "registrado");
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir BUSCAREMPLEADOFRAME");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEmpleadosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarEmpleadosFrame().setVisible(true);
            }
        });
    }
