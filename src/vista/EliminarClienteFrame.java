...
public class EliminarClienteFrame extends javax.swing.JFrame {
     ...
     * @param cmm
     */
    public EliminarClienteFrame(ControladorCliente ccc, ControladorMembresia cmm) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Datos Cliente");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Cliente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cedulat, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void eliminarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbtActionPerformed
        ...
        if(cli != null){
            if(cc.eliminarCliente(cli.getPerCedula())==true){
                JOptionPane.showMessageDialog(null, "El cliente a sido eliminado con exito");
                cedulat.setText("");
                cc.listarClientes();
                cm.listarMembresias();
            }else{
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("Salir EliminarClienteFrame");
        this.dispose();
