 ...
 * @author GerardoG
 */
public class EliminarTipoMedidaFrame extends javax.swing.JFrame {
    ControladorTipoMedida ctm = new ControladorTipoMedida();
    TipoMedida tm = null;
    /**
     * Creates new form EliminarTipoMedidaFrame
     * @param ctmm
     */
    public EliminarTipoMedidaFrame(ControladorTipoMedida ctmm) {
        initComponents();
        this.getContentPane().setBackground(new Color(125,125,125));
        this.ctm = ctmm;
    }

    private EliminarTipoMedidaFrame() {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Medida", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        System.out.println("buscar ELIMINARTIPOMEDIDAFRAME");
        tm = ctm.buscarMedida(nombret.getText());
        if(tm != null){
            JOptionPane.showMessageDialog(null, "El Tipo de medida se encuentra registrado");
        }else{
    ...
    private void eliminarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbtActionPerformed
        // TODO add your handling code here:
        System.out.println("eliminar ELIMINARTIPOMEDIDAFRAME");
        if(tm != null){
            if(ctm.eliminarMedida(tm.getId())==true){
                JOptionPane.showMessageDialog(null, "La medida a sido eliminada con exito");
                nombret.setText("");
                ctm.listarMedidas();
            }else{
                JOptionPane.showMessageDialog(null, "La medida no pudo ser eliminada");
            }
        }else{
            JOptionPane.showMessageDialog(null, "Medida no encontrada o Media no ingresada");
        }
    ...
    private void salirbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salirbtActionPerformed
        // TODO add your handling code here:
        System.out.println("salir ELIMINARTIPOMEDIDAFRAME");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarTipoMedidaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarTipoMedidaFrame().setVisible(true);
            }
        });
    }
