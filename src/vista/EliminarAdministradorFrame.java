 ...
 */
public class EliminarAdministradorFrame extends javax.swing.JFrame {

    ControladorAdministrador ca = new ControladorAdministrador();
    Administrador adm = null;
    /**
     * Creates new form EliminarAdministradorFrame
     * @param caa
     */
    public EliminarAdministradorFrame(ControladorAdministrador caa) {
        initComponents();
        this.getContentPane().setBackground(new Color(125,125,125));
        this.ca = caa;
    }

    private EliminarAdministradorFrame() {
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Datos Administrador");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Administrador", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 11), new java.awt.Color(255, 255, 255))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cedulat, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private void buscarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarbtActionPerformed
        ...
        if(adm != null){
            JOptionPane.showMessageDialog(null, "El administrador si se encuentra registrado");
        }else{
            JOptionPane.showMessageDialog(null, "El administrador no se encuentra registrado");
        }
    ...
    private void eliminarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarbtActionPerformed
        ...
        if(ca.eliminarAdministrador(cedulat.getText())==true){
            JOptionPane.showMessageDialog(null, "El administrador se elimino con exito");
            cedulat.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarAdministradorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EliminarAdministradorFrame().setVisible(true);
            }
        });
    }
